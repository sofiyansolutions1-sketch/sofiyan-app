...
export const DB_DATA = {
  Services: {
    "Electrician": [
        {name: "Switchbox installation", price: 199},
        {name: "AC switchbox installation", price: 229},
        {name: "Switch board installation", price: 149},
        {name: "Smart switch installation", price: 249},
        {name: "Smart appliance controller", price: 249},
        {name: "Wi-Fi smart switch installation", price: 149},
        ...
        {name: "Fan replacement (any type)", price: 199},
        {name: "Fan repair (any type)", price: 249},
        {name: "Fan regulator repair/replacement", price: 149},
    ...
    "AC": [
        {name: "AC Basic Check-up/Cooling Issue", price: 249},
