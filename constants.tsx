...
export const DB_DATA = {
  Services: {
    "Electrician": [
      {name: "Switchbox installation", price: 349},
      {name: "AC switchbox installation", price: 329},
    ...
    "AC": [
      {name: "AC Basic Check-up/Cooling Issue", price: 399},
      {name: "AC Basic Repair (Minor/Gas Check)", price: 399},
      {name: "Premium AC Service (Split)", price: 599},
      {name: "Premium AC Service (Window)", price: 549},
    ...
    "WashingMachine": [
      ...
      {name: "Washing machine servicing", price: 499},
    ...
    "Geyser": [
      ...
      {name: "Geyser Installation", price: 599},
      {name: "Geyser Uninstallation", price: 399}
    ],
    "WaterPurifier": [
      {name: "Water purifier check-up", price: 299},
      {name: "Filter check-up", price: 299},
    ...
    "Chimney": [
      {name: "Deep Service (2 visits)", price: 1900},
      {name: "Chimney Repair", price: 349},
      {name: "Basic Chimney Service", price: 599},
      {name: "Deep Chimney Service", price: 1099},
      {name: "Chimney Installation", price: 699},
      {name: "Chimney Uninstallation", price: 449}
    ],
    "TV": [
      {name: "TV Check-up", price: 249},
