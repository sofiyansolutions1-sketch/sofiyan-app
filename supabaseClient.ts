...
// Use environment variables for your Supabase connection, with the provided credentials as fallbacks
const SUPABASE_URL = (import.meta as any).env?.VITE_SUPABASE_URL || "https://vqbnzcknflwuhbiznuim.supabase.co";
const SUPABASE_ANON_KEY = ((import.meta as any).env?.VITE_SUPABASE_ANON_KEY || "sb_publishable_YKSbWVBxAltMjpIxGhNAIg_Ga8B9xST").trim();
