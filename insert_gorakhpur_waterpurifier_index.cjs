              ...
              seoDiv.innerHTML = \\\`
                  ...
                  <div class="space-y-5 text-base leading-relaxed">
                    ...
                    <div class="bg-gray-50 border-l-4 border-indigo-600 p-4 rounded mt-4">
                      <p><strong>Call:</strong> <a href="tel:9196029763" class="text-indigo-600 hover:underline">9196029763</a></p>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                      ...
                      <div class="mt-4 bg-indigo-50 p-4 rounded line-height-loose">
                        <p><strong>Call:</strong> <a href="tel:9196029763" class="text-indigo-700 hover:underline font-bold">9196029763</a></p>
...
const tsxContent = `
            {selectedService?.name === 'WaterPurifier' && localStorage.getItem('preferredCity') === 'Gorakhpur' && (
              <article className="mt-12 bg-white text-gray-800 font-sans border-t pt-8 border-gray-100">
                ...
                <div className="space-y-5 text-sm md:text-base leading-relaxed">
                  ...
                  <div className="bg-gray-50 border-l-4 border-indigo-600 p-4 rounded mt-4">
                    <p><strong>Call:</strong> <a href="tel:9196029763" className="text-indigo-600 hover:underline">9196029763</a></p>
                    <p><strong>Website:</strong> <a href="https://sofiyan.com" className="text-indigo-600 hover:underline">sofiyan.com</a></p>
                  </div>

                  <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4 border-b pb-2">RO Service Charges in Gorakhpur</h3>
                  ...
                  <h4 className="font-bold text-gray-900">Filter Replacement Services</h4>
                  <ul className="list-disc pl-5 space-y-2 mb-4">
                    <li><strong>Sediment Filter Replacement</strong> – Affordable Pricing</li>
                    <li><strong>Carbon Filter Replacement</strong> – Affordable Pricing</li>
                    <li><strong>RO Membrane Replacement</strong> – Custom Pricing</li>
                  ...
                  <p className="text-sm text-gray-500 italic mt-4">Final pricing depends on purifier type, filter condition, spare parts required, and water quality requirements.</p>

                  <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4 border-b pb-2">Why Gorakhpur Residents Choose Sofiyan RO Services</h3>
                  <div className="space-y-4">
                    <div>
                      <strong className="block text-gray-900">Same-Day Doorstep Assistance</strong>
                      <p>Quick support for urgent drinking water purification issues.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">Water Quality Experts</strong>
                      <p>Specialists trained to handle high TDS and groundwater purification challenges.</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <strong className="block text-gray-900">Genuine Filters & Spare Parts</strong>
                      <p>High-quality components ensure better purification efficiency and longer lifespan.</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <strong className="block text-gray-900">Health-Focused Solutions</strong>
                      <p>Services designed to maintain safe and hygienic drinking water standards.</p>
                    </div>
                    <div>
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4 border-b pb-2">Signs Your Water Purifier Needs Professional Service</h3>
                  <div className="space-y-4">
                    <div>
                      <strong className="block text-gray-900">Low Water Output</strong>
                      <p>Blocked filters or membrane issues may reduce water flow.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">Bad Taste or Odor in Water</strong>
                      <p>Filter deterioration can affect purification quality.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">Water Leakage Around RO Unit</strong>
                      <p>Loose fittings, damaged pipes, or tank issues may cause leakage.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">High TDS Levels</strong>
                      <p>Purification efficiency may decline over time.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">RO System Not Starting</strong>
                      <p>Electrical faults or pump failures may prevent operation.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">Unusual Noise During Operation</strong>
                      <p>Booster pump or internal component issues may create abnormal sounds.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">Slow Water Tank Filling</strong>
                      <p>Membrane blockage or pump issues may affect water production speed.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">Cloudy or Impure Water</strong>
                      <p>Purification systems may require maintenance or filter replacement.</p>
                    </div>
                  </div>

                  <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4 border-b pb-2">RO Problems We Frequently Resolve</h3>
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4 border-b pb-2">Our Gorakhpur RO Service Process</h3>
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4 border-b pb-2">Benefits of Regular RO Maintenance</h3>
                  <p>Routine servicing helps:</p>
                  <ul className="list-disc pl-5 space-y-2">
                   ...
                   <p className="mt-2">Experts recommend professional RO servicing every 3–6 months, especially in high TDS water areas.</p>

                  <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4 border-b pb-2">Frequently Asked Questions</h3>
                  <div className="space-y-4">
                    <div>
                      <strong className="block text-gray-900">What is the starting cost of RO repair in Gorakhpur?</strong>
                      <p>RO repair services start from ₹249*. Final pricing depends on the issue and replacement parts required.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">How often should RO filters be replaced?</strong>
                      <p>Most filters should be inspected every 6 months and replaced based on water quality and usage.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">Why is my RO water flow slow?</strong>
                      <p>Slow water flow is commonly caused by clogged filters, membrane blockage, or booster pump issues.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">Do you provide RO installation services?</strong>
                      <p>Yes. We provide installation, relocation, reinstallation, and uninstallation support.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">Is AMC available for water purifiers?</strong>
                      <p>Yes. We offer annual maintenance plans for residential and commercial systems.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">Which purifier brands do you service?</strong>
                      <p>We service Kent, Aquaguard, Livpure, Pureit, AO Smith, Blue Star, Havells, Eureka Forbes, LG, V-Guard, Aqua Fresh, Aqua Grand, and many more.</p>
                    </div>
                    <div>
                      <strong className="block text-gray-900">Do you service commercial RO plants?</strong>
                      <p>Absolutely. We provide repair and maintenance support for commercial and industrial purification systems.</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div className="mt-4 bg-indigo-50 p-4 rounded line-height-loose">
                      <p><strong>Call:</strong> <a href="tel:9196029763" className="text-indigo-700 hover:underline font-bold">9196029763</a></p>
                    ...
                    <p className="mt-4 font-bold text-gray-900">Enjoy safe, healthy, and purified drinking water every day with Gorakhpur’s trusted RO repair and maintenance experts.</p>
                  </div>
                </div>
              </article>
            )}
...
const indexAnchor = "if (categoryName === 'WaterPurifier' && localStorage.getItem('preferredCity') === 'Noida') {";
...
const tsxAnchor = "{selectedService?.name === 'WaterPurifier' && localStorage.getItem('preferredCity') === 'Noida' && (";
