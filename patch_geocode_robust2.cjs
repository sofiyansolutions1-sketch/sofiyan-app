...
if (startIndex !== -1) {
    ...
    if (endIndex !== -1) {
        const fullOldCode = content.substring(startIndex, endIndex + oldCodeEnd.length);
       ...
       // Always save the GPS coordinates and any successfully extracted info
       ...
       setIsTrackingLocation(false);
        ...
        console.log("Patched CustomerPanel geocode to be robust v2");
    } else {
