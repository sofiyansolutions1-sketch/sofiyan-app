...
export const rateCardDatabase: Record<string, Record<string, RateCardItem[]>> = {
  "AC Service": {
    ...
    "Gas Charging": [
      { name: "Gas Leak Fix and Refilling (1 Ton)", price: "₹2800" },
      { name: "Gas Leak Fix and Refilling (1.5 Ton)", price: "₹3200" },
      { name: "Gas Leak Fix and Refilling (2 Ton)", price: "₹3500" },
  ...
  "Water Purifier": {
    ...
    "Aquaguard Spares": [
      ...
      { name: "Aquaguard RO Active Copper Kit", price: "₹7100 + ₹299 (Labour)" }
    ]
  }
};
